...
void UnitExtractWidget::updateGUI()
{
    ...
    {
        i = MainWindow::QRCodeToQImageConverter(Stop312ProcessQRString,1.8,  versionIndex, levelIndex, bExtent, maskIndex);
    ...
    {
        i = MainWindow::QRCodeToQImageConverter(Start312ProcessQRString,1.8,  versionIndex, levelIndex, bExtent, maskIndex);
        ui->qrstartstop->setPixmap( QPixmap::fromImage( i ) );
